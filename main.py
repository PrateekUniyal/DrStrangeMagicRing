...
def transparent(targetImg, x, y, size=None):
    ...
    mask = cv2.medianBlur(a, 5)  # Adjusted the mask blur size to 5
    h, w, _ = overlay_color.shape
    if y + h > newFrame.shape[0] or x + w > newFrame.shape[1]:
        return newFrame
